...
namespace WebAPINwind.Controllers
{
    ...
    public class EmployeesController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("/byCompany")]
        public IEnumerable<Object> GetEnplaoyeeByCompany() {
        ...
        public IEnumerable<Object> GetTop5()
        {
            return _context.Employees
                ...
                .Join(_context.Movements, e => e.EmployeeId, m => m.EmployeeId, (e, m) => new
                {
                ...
                .Join(_context.Movementdetails, em => em.IdMovimiento, md => md.MovementId, (em, md) => new
                {
